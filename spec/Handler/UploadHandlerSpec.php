...
class UploadHandlerSpec extends ObjectBehavior
{
    ...
    public function let(
        ...
        $this->beConstructedWith($metadataRepo, $propertyHandler, $filesystemAdapterRepoLazyLoader, $namerRepo,
            $dispatcher);
    ...
    public function it_should_not_handle_a_file_reference_if_action_is_stopped_on_event(
        $fileReference,
        $filesystem,
        $uploadEvent,
        $propertyHandler
    ...
    public function it_should_not_inject_an_uri_if_a_file_path_is_empty($fileReference, $propertyHandler)
    {
    ...
    public function it_should_not_inject_an_uri_if_an_uri_is_not_injectable($fileReference, $propertyHandler, $metadata)
    {
    ...
    public function it_should_not_inject_a_file_info_if_a_file_path_is_empty($fileReference, $propertyHandler)
    {
        $propertyHandler->getFile($fileReference, Arg::any())->willReturn('');
    ...
    public function it_should_not_inject_a_file_info_if_a_file_info_setter_is_disabled(
        $fileReference,
        $propertyHandler,
        $metadata
    ) {
    ...
    public function it_should_not_inject_a_file_info_if_a_file_info_is_not_injectable(
        $fileReference,
        $propertyHandler,
        $metadata
    ) {
    ...
    public function it_should_not_inject_a_file_info_if_a_file_info_is_not_resolved(
        $fileReference,
        $propertyHandler,
        $filesystem
    ) {
    ...
    public function it_should_not_match_different_files($fileReference, $propertyHandler, FileReference $fileReference2)
    {
    ...
    public function it_should_match_equal_files($fileReference, $propertyHandler, FileReference $fileReference2)
    {
    ...
    public function it_should_not_delete_if_file_reference_does_not_have_a_file($fileReference, $propertyHandler)
    {
        $propertyHandler->getFile($fileReference, Arg::any())->willReturn(null);
        $this->delete($fileReference)->shouldBe(false);
    }

    public function it_should_not_delete_if_that_could_not_delete_from_filesystem(
        $fileReference,
        $filesystem,
        $propertyHandler
    ) {
    ...
    public function it_should_not_delete_if_file_reference_is_not_deletable($fileReference, $metadata)
    {
        $metadata->isDeletable()->willReturn(false);
        $this->delete($fileReference)->shouldBe(false);
    }

    public function it_should_not_delete_old_file_if_old_file_is_not_deletable($fileReference, $metadata)
    {
        $metadata->isOldFileDeletable()->willReturn(false);
        $this->deleteOldFile($fileReference)->shouldBe(false);
    }

    public function it_should_dispatch_on_upload($fileReference, $dispatcher)
    {
    ...
    public function it_should_dispatch_on_update($fileReference, $dispatcher)
    {
    ...
    public function it_should_dispatch_on_delete($fileReference, $dispatcher)
    {
    ...
    public function it_should_dispatch_on_delete_an_old_file($fileReference, $dispatcher)
    {
    ...
    public function it_should_dispatch_on_inject_an_uri($fileReference, $dispatcher)
    {
    ...
    public function it_should_dispatch_on_inject_a_file_info($fileReference, $dispatcher)
    {
    ...
    public function it_should_delete_a_file($fileReference, $propertyHandler)
    {
        $propertyHandler->getFile($fileReference, Arg::any())->willReturn('relative/file/path/on/filesystem');
    ...
    public function it_should_have_an_uploaded_file($fileReference)
    {
        $this->shouldHaveUploadedFile($fileReference);
    }

    public function it_should_throw_exception_on_upload($fileReference, $filesystem, $fileInfo)
    {
    ...
    public function it_should_update_a_file($fileReference, $propertyHandler, $filesystem)
    {
        $filesystem->writeStream($this->fsPrefix, Arg::type('string'), Arg::any())->shouldBeCalled();
        $propertyHandler->setFile($fileReference, Arg::any(), Arg::type('string'))->shouldBeCalled();
        $this->update($fileReference);
    ...
    public function it_should_check_whether_the_object_is_a_file_reference($fileReference, $metadataRepo)
    {
